        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl font-normal text-gray-900 mb-6 leading-tight">
              Everything you need to excel in<br />
              your <span className="inline-flex items-center bg-secondary-100 px-3 py-1 rounded-lg">📚</span> academic journey
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-2xl font-medium text-gray-900 mb-3">Upload Your Assignment</h3>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-2xl font-medium text-gray-900 mb-3">Find Your Perfect Tutors</h3>
                  <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-gray-900">Available Tutors</span>
                    <div className="w-6 h-6 bg-secondary-300 rounded-full"></div>
                  </div>
                  
                  <div className="text-sm text-gray-500 mb-3">Mathematics</div>
                  <div className="text-sm text-gray-500 mb-4">Physics • Chemistry</div>
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-500">PhD Mathematics • 5+ years experience • ⭐ 4.9 rating</div>
                    </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-2xl font-medium text-gray-900 mb-3">Learn from the Best</h3>
                  <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg">
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="text-sm text-gray-500">Advanced Calculus</div>
                  </div>
                  
                  <div className="border-t pt-4">
                    <div className="text-lg font-bold text-gray-900 mb-2">Progress Tracking</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[500px]">
              ...
              <div className="p-12 flex flex-col justify-center">
                ...
                <p className="text-gray-600 mb-8 leading-relaxed">
                  We're here to help! Whether you have a question about our tutoring services, need assistance with your account, or want to join our team of expert tutors, we're ready to assist you.
                </p>
                ...
                <div className="flex space-x-4">
                  ...
                  <button className="bg-primary-300 text-white px-8 py-3 rounded-lg font-medium hover:bg-primary-600 transition-colors flex items-center space-x-2">
