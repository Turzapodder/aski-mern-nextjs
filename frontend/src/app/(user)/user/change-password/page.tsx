...
const ChangePassword = () => {
  ...
  return (
    <div className="flex items-start justify-center pt-10 h-full">
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        ...
        {serverSuccessMessage && <div className="text-sm text-primary-500 font-semibold px-2 text-center">{serverSuccessMessage}</div>}
