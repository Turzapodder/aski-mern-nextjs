  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-3 sm:p-4">
      <div className="w-full max-w-7xl bg-white rounded-2xl shadow-xl flex flex-col md:flex-row overflow-hidden">
        ...
        {/* Right Side - Form */}
        <div className="w-full md:w-1/2 p-5 sm:p-8 lg:p-12 xl:p-16">
          <div className="flex gap-3 items-center mt-2 sm:mt-5 mb-6 sm:mb-10">
            <Image
          ...
          {showFormNotification && formData?.formData && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              ...
              <p className="text-blue-700 text-sm">
                Complete registration to continue with: &quot;
                {formData.formData.description?.substring(0, 50)}...&quot;
              </p>
            </div>
          )}
