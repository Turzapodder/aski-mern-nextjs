          ...
          <div className="w-full lg:w-1/2 p-5 sm:p-8 lg:p-12 flex flex-col justify-between">
            ...
            <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
              ...
              <button
                ...
                className="w-full bg-primary-500 text-white py-2.5 sm:py-3 rounded-full font-medium hover:bg-black hover:text-white transition-colors disabled:bg-gray-400"
              >
                Submit
              </button>
