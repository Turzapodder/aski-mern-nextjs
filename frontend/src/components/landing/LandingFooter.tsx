...
export const LandingFooter = () => {
    return (
        <footer className="bg-black text-white pt-16 sm:pt-20 pb-10 px-4 rounded-t-2xl sm:rounded-t-[3rem] mt-16 sm:mt-20">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col lg:flex-row justify-between items-start gap-12 mb-16">
                    <div className="max-w-sm w-full">
                        ...
                        <div className="flex items-center gap-2 bg-gray-900 p-1.5 rounded-full border border-gray-800">
                            ...
                            <button className="bg-white text-black rounded-full px-5 sm:px-6 py-2 text-xs sm:text-sm font-bold whitespace-nowrap">Join Now</button>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 sm:gap-16 text-sm text-gray-400 w-full lg:w-auto">
                        <div className="space-y-4">
                            ...
                            <Link href="#" className="block hover:text-white transition-colors">Find Tutors</Link>
                            <Link href="#" className="block hover:text-white transition-colors">Post Assignment</Link>
                            <Link href="#" className="block hover:text-white transition-colors">How it Works</Link>
                        </div>
                        <div className="space-y-4">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-900 text-[10px] sm:text-xs text-gray-500 gap-6">
                    <div className="flex items-center gap-2 order-2 md:order-1">
                        <div className="w-6 h-6 bg-white/10 rounded flex items-center justify-center text-white font-serif font-bold text-[10px]">A</div>
