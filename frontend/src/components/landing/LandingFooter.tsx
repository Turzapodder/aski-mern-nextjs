          ...
          <div className="max-w-sm w-full">
            ...
            <div className="flex items-center gap-2 bg-gray-900 p-1.5 rounded-full border border-gray-800">
              <input
                ...
                className="bg-transparent px-4 text-sm outline-none w-full"
              />
              <button className="bg-white text-black rounded-full px-5 sm:px-6 py-2 text-xs sm:text-sm font-bold whitespace-nowrap">
                Join Now
              </button>
            </div>
          </div>
