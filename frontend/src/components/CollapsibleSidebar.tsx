  ...
  const mainMenuItems = isTutor
    ? [
        ...
        },
        {
          ...
          href: userData?.user?._id ? `/user/tutors/tutor-profile/${userData.user._id}` : '#',
          active: activeItem === 'tutor-profile',
        },
        {
        ...
        {sidebarSections.map((section) => {
          return (
            <div key={section.title}>
              ...
              {!isCollapsed && (
                <div className="mb-3">
                  <h3 className="text-sm text-black uppercase tracking-wider">{section.title}</h3>
                </div>
              )}
                    ...
                    >
                      ...
                      >
                        <Image
                          ...
                          width={30}
                          height={30}
                          className={`min-w-[30px] min-h-[30px] w-[30px] h-[30px] object-contain transition-all ${
                            !isCollapsed && 'mr-3'
      ...
      <div className="p-4 border-t border-gray-200">
        {!isCollapsed ? (
          <div className="flex items-center justify-between bg-white p-3 rounded-xl shadow-sm border border-gray-100">
            <Link
              href="/user/profile"
              className="flex items-center space-x-3 overflow-hidden flex-1 min-w-0 mr-2 group"
            >
