                ...
                <div className="flex items-start gap-3">
                    ...
                    {avatar ? (
                      ...
                      <div
                        className={`w-12 h-12 rounded-full flex items-center justify-center text-sm font-medium ${
                          isActive ? 'bg-white/10 text-white' : 'bg-primary-100 text-primary-600'
                        }`}
                      >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-start mb-1">
                      ...
                      {lastMessage && (
                        <span
                          className={`text-xs whitespace-nowrap ${isActive ? 'text-gray-300' : 'text-gray-400'}`}
                        >
                    ...
                    <div className="flex justify-between items-end">
                      <p
                        className={`text-xs truncate max-w-[160px] ${isActive ? 'text-gray-300' : 'text-gray-500'}`}
                      >
                        {previewText}
                      </p>
