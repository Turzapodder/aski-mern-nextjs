...
export function DndProvider({
  ...
  const [showConfirmation, setShowConfirmation] = useState<boolean>(showConfirmationProp);
  ...
  const handleConfirmDrop = useCallback(() => {
    ...
    const callback = onEventDroppedRef.current;
    if (callback) {
      callback(pendingDropData.event, pendingDropData.newStartDate, pendingDropData.newEndDate);
    }
