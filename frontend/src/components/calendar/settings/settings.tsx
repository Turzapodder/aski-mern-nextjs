    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56">
        ...
        <DropdownMenuGroup>
          <DropdownMenuItem>
            Use dark mode
            <DropdownMenuShortcut className="ml-auto flex items-center gap-2">
              {isDarkMode ? (
          ...
          <DropdownMenuItem>
            ...
            <DropdownMenuShortcut className="ml-auto flex items-center gap-2">
              {showConfirmation ? <CheckIcon className="h-4 w-4" /> : <XIcon className="h-4 w-4" />}
              <Switch
          ...
          <DropdownMenuItem>
            Use dot badge
            <DropdownMenuShortcut className="ml-auto flex items-center gap-2">
              {isDotVariant ? <DotIcon className="w-4 h-4" /> : <PaletteIcon className="w-4 h-4" />}
              <Switch
