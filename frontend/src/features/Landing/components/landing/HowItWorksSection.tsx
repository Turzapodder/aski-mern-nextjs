      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 items-center">
            ...
            <div className="space-y-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center gap-4 p-4 rounded-2xl bg-gray-50">
                  ...
                  <div className="h-4 w-16 bg-blue-100 rounded text-blue-600 text-xs flex items-center justify-center font-bold">
                    Active
                  </div>
                </div>
              ))}
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-500 mb-8 leading-relaxed">
            Our streamlined process makes getting help simple and stress-free. Focus on learning
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  Share details about your project, deadline, and budget.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  Review bids and profiles to select the best match for you.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  Receive your solution, review it, and release payment.
                </p>
              </div>
            </div>
          </div>
