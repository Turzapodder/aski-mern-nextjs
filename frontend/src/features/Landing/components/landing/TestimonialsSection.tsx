  ...
  const testimonials = [
    {
      ...
      text: 'Aski saved my semester! The tutor helped me debug my final project in record time.',
    },
    {
      name: 'Sarah Johnson',
      role: 'Business Major',
      text: 'I was struggling with accounting, but my tutor on Aski explained everything so clearly. Highly recommend!',
    },
    {
      name: 'Michael Brown',
      role: 'Engineering Student',
      text: 'The platform is so easy to use. I posted my assignment and got great bids within minutes.',
    },
  ];
