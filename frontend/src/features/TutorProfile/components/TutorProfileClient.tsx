              ...
              <div className="grow">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center ${isBookmarked ? 'bg-amber-50 text-amber-600' : 'bg-purple-50'
                          }`}
                      >
                  ...
                  {getDaysInMonth().map((item, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`aspect-square rounded-xl text-xs font-semibold flex flex-col items-center justify-center relative transition-all ${isSelected
                        ...
                        {slots.map((item) => {
                          ...
                          return (
                            <button
                              ...
                              className={`px-3 py-2 text-xs font-bold rounded-xl border transition-all ${isSlotSelected
                          ...
                          <div className="grid grid-cols-2 gap-3 mb-4">
                            ...
                            {(tutor?.tutorProfile?.allowedSessionDurations || [30, 60]).includes(30) && (
                              <button
                                ...
                                className={`p-4 rounded-2xl border text-left transition-all ${selectedDuration === 30
                            ...
                            {(tutor?.tutorProfile?.allowedSessionDurations || [30, 60]).includes(60) && (
                              <button
                                ...
                                className={`p-4 rounded-2xl border text-left transition-all ${selectedDuration === 60
                                    ? 'border-purple-600 bg-purple-50/50 shadow-sm'
                                    : 'border-gray-200 hover:border-purple-200'
                                  }`}
                              >
