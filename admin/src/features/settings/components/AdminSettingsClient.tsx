...
import { useAdminSettingsLogic } from '../hooks/useAdminSettingsLogic';
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <Card className="border border-gray-200/70 bg-white/90 shadow-sm">
              ...
              <CardContent className="space-y-2 text-sm text-gray-600">
                ...
                <Link className="text-primary font-medium" href="/settings/quiz">
                  Open quiz manager
                </Link>
              </CardContent>
            </Card>
            <Card className="border border-gray-200/70 bg-white/90 shadow-sm">
              ...
              <CardContent className="space-y-2 text-sm text-gray-600">
                ...
                <Link className="text-primary font-medium" href="/settings/admins">
                  Manage admins
                </Link>
              </CardContent>
            </Card>
