...
import { roleLabel, statusTone, useAdminUsersLogic } from '../hooks/useAdminUsersLogic';
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage student and tutor accounts across the platform.
          </p>
        </div>
      </div>
                      ...
                      return (
                        <tr key={user.id} className="hover:bg-gray-50/60">
                          ...
                          <td className="py-3 pr-4 text-gray-700">
                            {Number.isFinite(user.totalSpent)
                    ...
                    >
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem
                              onClick={() => openModal(user, isBanned ? 'unban' : 'ban')}
                              className={
                                isBanned ? 'text-emerald-600 text-xs' : 'text-rose-600 text-xs'
                              }
                            >
                              {isBanned ? (
                      ...
                      <div className="mt-4 grid grid-cols-2 gap-4 border-t border-gray-50 pt-4">
                        ...
                        <div className="space-y-1 text-right">
                          ...
                          <span
                            className={`inline-block rounded-full px-2 py-0.5 text-[10px] font-bold ${statusTone(user.status)}`}
                          >
                            {user.status}
                          </span>
                        </div>
