...
} from '../hooks/useAdminDashboardLogic';
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <Card className="relative overflow-hidden border border-gray-200/70 bg-white/90 shadow-sm backdrop-blur">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="text-xs text-gray-500">
              Escrow: {formatCurrency(stats?.revenue.escrow ?? 0)} | Available:{' '}
              {formatCurrency(stats?.revenue.available ?? 0)}
            </div>
        ...
        <Card className="relative overflow-hidden border border-gray-200/70 bg-white/90 shadow-sm backdrop-blur">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="text-xs text-gray-500">
              Students: {formatNumber(stats?.users.totalStudents ?? 0)} | Tutors:{' '}
              {formatNumber(stats?.users.totalTutors ?? 0)}
            </div>
        ...
        <Card className="relative overflow-hidden border border-gray-200/70 bg-white/90 shadow-sm backdrop-blur">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="text-xs text-gray-500">
              ...
              {formatNumber(stats?.pending.disputes ?? 0)} | Withdrawals:{' '}
              {formatNumber(stats?.pending.withdrawals ?? 0)}
            </div>
        ...
        <Card className="relative overflow-hidden border border-gray-200/70 bg-white/90 shadow-sm backdrop-blur">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="text-xs text-gray-500">
              Pending, assigned, and submitted assignments
            </div>
            <TrendBadge trend={defaultTrend} />
          </CardContent>
        </Card>
          ...
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">
                Student and tutor onboarding over the last 30 days
              </p>
            </div>
          </CardHeader>
      ...
      <Card className="border border-gray-200/70 bg-white/90 shadow-sm backdrop-blur">
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500">
              Latest actions across users, payments, and disputes
            </p>
          </div>
        </CardHeader>
        <CardContent>
